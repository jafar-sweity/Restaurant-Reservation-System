...
namespace RestaurantReservation.Db.Extensions
{
    ...
    private static Reservation[] GetReservations()
    {
        ...
        {
                new Reservation { ReservationId = 1, customerId = 1, RestaurantId = 1, TableId = 1, reservation_date = DateTime.Now, PartySize = 4 },
                new Reservation { ReservationId = 2, customerId = 2, RestaurantId = 2, TableId = 3, reservation_date = DateTime.Now, PartySize = 6 },
                new Reservation { ReservationId = 3, customerId = 3, RestaurantId = 3, TableId = 5, reservation_date = DateTime.Now, PartySize = 4 },
                new Reservation { ReservationId = 4, customerId = 4, RestaurantId = 1, TableId = 2, reservation_date = DateTime.Now, PartySize = 2 },
                new Reservation { ReservationId = 5, customerId = 5, RestaurantId = 2, TableId = 4, reservation_date = DateTime.Now, PartySize = 4 },
        };
    }
